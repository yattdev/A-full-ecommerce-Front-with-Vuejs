                            ...
                            <div class="col-12 mt-3 ">
                                <nav aria-label="breadcrumb" class="second ">
                                    <ol class="breadcrumb indigo lighten-6 first ">
                                        <li class="breadcrumb-item font-weight-bold "><router-link class="black-text text-uppercase" to="/"><span class="mr-md-3 mr-1">BACK TO SHOP</span></router-link><i class="fa fa-angle-double-right " aria-hidden="true"></i></li>
                                        <li class="breadcrumb-item font-weight-bold"><router-link class="black-text text-uppercase" to="/cart"><span class="mr-md-3 mr-1">SHOPPING BAG</span></router-link><i class="fa fa-angle-double-right text-uppercase " aria-hidden="true"></i></li>
                                        <li class="breadcrumb-item font-weight-bold"><router-link class="black-text text-uppercase" to="#"><span class="mr-md-3 mr-1">CHECKOUT</span></router-link></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
